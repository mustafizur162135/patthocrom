                        ...
                        <div class="col-12 col-4">
                            <div class="top_courses">
                                ...
                                <div class="details">
                                    ...
                                    <div class="tc_footer">
                                        <div class="tc_price float-right">৳{{ $teacherpackage->teacherpackage_price }}
                                        </div>
                                        <div class="tc_price float-left">
                                            ...
                                            @if ($teacherUserData)
                                                <form method="post" action="{{ route('student.checkout') }}">
                                                    ...
                                                    <input type="text" name="studentPackage_id"
                                                        value="{{ $teacherpackage->id }}">
                                                    <input type="text" name="studentpackage_price"
                                                        value="{{ $teacherpackage->teacherpackage_price }}">
                                                    <input type="text" name="studentpackage_name"
