                    ...
                    <div class="blog_post_home6 style2 video">
                        <div class="bg_img_video_widget h500 thumb">
                            ...
                            <div class="video-container">
                                <img class="img-whp"
                                    src="{{ asset('images/studentpackages/' . $studentPackage->studentpackage_image) }}"
                ...
                <div class="col-lg-4 col-xl-3 pl-lg-0 pr-lg-0">
                    <div class="sidebar_course_widget style2">
                        <div class="course_list_details">
                            <div class="price_title df">৳ <span
                                    class="custome_price pr10 pl10 vas">{{ $studentPackage->studentpackage_price }}</span>
                            </div>
                            ...
                            @if ($studentUserData)
                                <form method="post" action="{{ route('student.checkout') }}">
                                    ...
                                    <button type="submit"
                                        class="btn btn-block buy_now_btn dbxshad btn-lg btn-thm3 mt20">Buy Now</button>
                                </form>

                                {{-- <a class="btn btn-block buy_now_btn dbxshad btn-lg btn-thm3 mt20" href="{{ route('student.checkout') }}">Buy Now</a> --}}
                            @else
                                <a class="btn btn-block buy_now_btn dbxshad btn-lg btn-thm3 mt20"
                                    href="{{ route('student.login.form') }}">Buy Now</a>
                            @endif
