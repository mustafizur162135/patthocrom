            ...
            <div class="col-lg-6 col-xl-6">
                <div class="about_home3">
                    ...
                    <ul class="partners_thumb_list">
                        <li class="list-inline-item"><a href="#"><img class="img-fluid" src="{{ asset('frontend/images/partners/1.png') }}" alt="1.png"></a></li>
                        <li class="list-inline-item"><a href="#"><img class="img-fluid" src="{{ asset('frontend/images/partners/2.png') }}" alt="2.png"></a></li>
                        <li class="list-inline-item"><a href="#"><img class="img-fluid" src="{{ asset('frontend/images/partners/3.png') }}" alt="3.png"></a></li>
                        <li class="list-inline-item"><a href="#"><img class="img-fluid" src="{{ asset('frontend/images/partners/4.png') }}" alt="4.png"></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6 col-xl-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="about_home3_shape_container">
                    <div class="about_home3_shape"><img src="{{ asset('frontend/images/about/shape1.png') }}" alt="shape1.png"></div>
                </div>
            </div>
        </div>
    </div>
