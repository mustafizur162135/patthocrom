    ...
    <div class="row">
        <div class="col-12">
            <div class="main-card mb-3 card">
                ...
                action="{{ route('sliders.update', ['slider' => $slider]) }}" enctype="multipart/form-data">
        ...
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slider_name" name="slider_name" value="{{ $slider->slider_name }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" cols="40" rows="5" id="slider_des" name="slider_des"
                                placeholder="Enter slider Description">{{ $slider->slider_des }}</textarea>
                        </div>
