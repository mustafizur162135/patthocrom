    ...
    <div class="row">
        <div class="col-12">
            <div class="main-card mb-3 card">
                ...
                action="{{ route('studentpackages.update', ['studentpackage' => $studentpackage]) }}" enctype="multipart/form-data">
        ...
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple" id="exam_id"
                                ...
                                @foreach ($exams as $exam)
                                    <option value="{{ $exam->id }}" {{ isset($studentpackage) && $studentpackage->exam_id == $exam->id ? 'selected' : '' }}>
                                        {{ $exam->exam_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="studentpackage_name" name="studentpackage_name" value="{{ $studentpackage->studentpackage_name }}" 
                                 placeholder="Enter studentpackage Name" required autofocus>
                        </div>

                        <div class="form-group">
                            <label for="studentpackage_price">studentpackage Price</label>
                            <input type="number" class="form-control" id="studentpackage_price" name="studentpackage_price" value="{{ $studentpackage->studentpackage_price }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" cols="40" rows="5" id="studentpackage_des" name="studentpackage_des"
                                placeholder="Enter studentpackage Description">{{ $studentpackage->studentpackage_des }}</textarea>
                        </div>
