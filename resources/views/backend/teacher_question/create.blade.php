    ...
    <div class="row">
        <div class="col-12">
            <div class="main-card mb-3 card">
                <form id="classForm" role="form" method="POST" action="{{ route('teacher.exam.store') }}"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" cols="40" rows="5" id="exam_desc" name="exam_desc"></textarea>
                                </div>
                            </div>
